...
contract MockToken is ManagedToken, Observable {
     ...
     *
     * @param _account Account to set balance for
     * @param _value New balance
     */
    function setBalance(address _account, uint _value) public {
        totalTokenSupply -= balances[_account];
